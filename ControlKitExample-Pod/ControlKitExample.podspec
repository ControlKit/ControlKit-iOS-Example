...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "http://EXAMPLE/ForceUpdateKit"
  ...
  # Or just: spec.author    = "Maziar Saadatfar"
  # spec.authors            = { "Maziar Saadatfar" => "maziar.saadatfar@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/Maziar Saadatfar"
  ...
  spec.source       = { :git => "http://EXAMPLE/ForceUpdateKit.git", :tag => "#{spec.version}" }
